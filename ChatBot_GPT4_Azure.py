...
class Assistant:
    def __init__(self):
        ...
        self.context = [
            {
                "role": "system",
                "content": """Eres un asistente virtual cordial donde tendras las siguientes labores: {services}""",
            }
        ]
    ...
    def get_completion(self, prompt, model="gpt-4-vision-preview"):
    ...
    def get_completion_from_messages(self, messages, model="gpt-4-vision-preview", temperature=0):
        response = client.chat.completions.create(
            model=model,
            messages=messages,
